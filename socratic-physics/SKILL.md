...
description: Stress-test a physics argument, model, or protocol by systematic Socratic questioning. Use when the user wants feedback on physics topics; when they ask to interrogate, cross-examine, or stress-test a physics argument, draft, note, or idea; or when a shared understanding for a physics argument or project is needed.
